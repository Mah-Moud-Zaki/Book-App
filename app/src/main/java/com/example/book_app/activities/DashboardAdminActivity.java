...
public class DashboardAdminActivity extends AppCompatActivity {
    ...
    private AdapeterCategory adapeterCategory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.searchEt.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                try {
                    adapeterCategory.getFilter().filter(s);
                }
                catch (Exception e){
    ...
    private void loadCategories() {
        ...
        ref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapeterCategory=new AdapeterCategory(DashboardAdminActivity.this,categoryArrayList);
                binding.categoriesRv.setAdapter(adapeterCategory);
    ...
    private void checkUser() {
        ...
        if (firebaseUser==null){
            ...
            binding.supTitleTv.setText(email);
        }
    }
}